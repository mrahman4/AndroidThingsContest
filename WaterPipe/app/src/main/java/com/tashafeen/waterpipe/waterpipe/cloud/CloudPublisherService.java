 ...
 */
package com.tashafeen.waterpipe.waterpipe.cloud;
...
import com.tashafeen.waterpipe.waterpipe.SensorData;
import com.tashafeen.waterpipe.waterpipe.cloud.cloudiot.CloudIotOptions;
import com.tashafeen.waterpipe.waterpipe.cloud.cloudiot.MQTTPublisher;
...
public class CloudPublisherService extends Service {
    ...
    private static final String INTENT_CONFIGURE_ACTION =
            "com.tashafeen.waterpipe.waterpipe.mqtt.CONFIGURE";
    ...
    private static final int BUFFER_SIZE_FOR_ONCHANGE_SENSORS = 1;
