...
package com.tashafeen.waterpipe.waterpipe.cloud.cloudiot;
...
import com.tashafeen.waterpipe.waterpipe.cloud.CloudPublisher;
import com.tashafeen.waterpipe.waterpipe.cloud.MessagePayload;
...
public class MQTTPublisher implements CloudPublisher {
    ...
    private static final boolean SHOULD_RETAIN = true;
